...
PLANNER_MODEL=bedrock:us.anthropic.claude-sonnet-4-5-20250929-v1:0
```

`PLANNER_MODEL`을 비워도 코드 기본값은 Bedrock Sonnet입니다. 커스텀 포맷 분석, 실행 계획 수정, Intent Router fallback은 별도 모델을 지정하지 않으면 이 Planner 기본값을 사용합니다.
