...
| `segmentation` | `grounding_dino` -> `sam` | bbox 탐지 후 SAM2 polygon refinement. SAM3 backend 선택 시 text prompt 기반 직접 segment 생성 가능 |
