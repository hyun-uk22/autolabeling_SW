...
def build_workflow_graph(runtime: WorkflowRuntime, checkpointer=None):
    ...
    def begin_operation(state: WorkflowState) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_first_pass_report": {},
            "current_specialist_consistency": {},
            "current_issues": [],
            "high_required": False,
            "high_approved": False,
    ...
    def run_specialists(state: WorkflowState) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_first_pass_report": output.get("first_pass_report", {}),
            "current_specialist_consistency": output.get("specialist_consistency", {}),
    ...
    def save_generated(state: WorkflowState) -> Dict[str, Any]:
        record = {
            ...
            "first_pass_report": state.get("current_first_pass_report", {}),
            "specialist_consistency": state.get("current_specialist_consistency", {}),
